...
ctxs.append('LogregTorchSamba_partition_1_0__ptconvlstm__indexselect_recompute__kIndexRd')
def LogregTorchSamba_partition_1_0__ptconvlstm__indexselect_recompute__kIndexRd():
    x0 = 16
    x1 = 1
    x2 = 32
    x3 = 64
...
ndaddr_funcs['LogregTorchSamba_partition_1_0__ptconvlstm__indexselect_recompute__kIndexRd'] = LogregTorchSamba_partition_1_0__ptconvlstm__indexselect_recompute__kIndexRd
