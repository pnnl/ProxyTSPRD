module @partition_0_0_ attributes {rail.kChipId = 0 : i64, rail.kIsSectionModule = true, rail.kSectionId = 0 : i64}  {
  module @tbuf2u_0_0_334  {
    "rail.buffer"() ( {
      ...
      }) {kArithSplit = true, kContextType = "kRolled", kName = "LogregTorchSamba.partition_0_0_.ptconvlstm__indexselect@kLutRd", kSourceContext = loc("software/templates/src/templates/index/rail/Index.cpp":137:0), rail.kMetapipeIterCounts = [1], sym_name = "LogregTorchSamba.partition_0_0_.ptconvlstm__indexselect@kLutRd"} : () -> ()
      "rail.terminator"() {kSourceContext = loc("LogregTorchSamba.cpp":922:0)} : () -> ()
    }) {kFIFOMode = false, kName = "tbuf2u_0_0_334", kSourceContext = loc("LogregTorchSamba.cpp":922:0), params = {kDepth = 2 : i64, kLayout = {alignments = [[1, 64]], base_address = 0 : i64, dim_order = [0, 1], format = 9 : i64, shape = [60, 64], vector_transpose = 0 : i64}, kMinMaxCapacitySplit = true, kMinPmus = -1 : i64, kPacingWindow = -1 : i64, kSplitAlgorithm = 0 : i64}, sym_name = "tbuf2u_0_0_334"} : () -> ()
    module_terminator {kSourceContext = loc("LogregTorchSamba.cpp":922:0)}
  }
  module @tbuf1u_0_0_335  {
    "rail.buffer"() ( {
      "rail.context"() ( {
        %4 = "rail.const"() {kSourceContext = loc("software/compiler/rail/src/lib/node/tbuffer/TBufferContext.cpp":469:0), kValue = 0 : i64} : () -> ui32
      ...
      "rail.context"() ( {
        ...
        %10 = "rail.const"() {kSourceContext = loc("software/templates/src/templates/index/rail/Index.cpp":124:0), kValue = 64 : i64} : () -> ui32
      ...
      }) {kContextType = "kRolled", kName = "LogregTorchSamba.partition_0_0_.ptconvlstm__indexselect@kIndexRd", kSourceContext = loc("software/templates/src/templates/index/rail/Index.cpp":124:0), rail.kMetapipeIterCounts = [1], sym_name = "LogregTorchSamba.partition_0_0_.ptconvlstm__indexselect@kIndexRd"} : () -> ()
      "rail.terminator"() {kSourceContext = loc("LogregTorchSamba.cpp":933:0)} : () -> ()
    }) {kFIFOMode = false, kName = "tbuf1u_0_0_335", kSourceContext = loc("LogregTorchSamba.cpp":933:0), params = {kDepth = 1 : i64, kLayout = {alignments = [], base_address = 0 : i64, dim_order = [0], format = 5 : i64, shape = [1], vector_transpose = 0 : i64}, kMinMaxCapacitySplit = true, kMinPmus = -1 : i64, kPacingWindow = -1 : i64, kSplitAlgorithm = 0 : i64}, sym_name = "tbuf1u_0_0_335"} : () -> ()
    module_terminator {kSourceContext = loc("LogregTorchSamba.cpp":933:0)}
  }
  module @LogregTorchSamba.partition_0_0_.ptconvlstm__indexselect attributes {rail.kMetapipeIterCounts = [1]}  {
    module_terminator {kSourceContext = loc("LogregTorchSamba.cpp":946:0)}
  }
  module @tbuf2u_0_0_342  {
    "rail.buffer"() ( {
      "rail.context"() ( {
        ...
        %19 = "rail.io.control_out"() {kCtxName = "LogregTorchSamba.partition_0_0_.ptconvlstm__indexselect@kOutWr", kLanes = [], kPortName = "1000", kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0), kUnitName = "tbuf2u_0_0_342", sym_name = "1000"} : () -> i1
        "rail.send"(%13, %19) {kOpRWPattern1 = "kWriteOperand", kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0)} : (i1, i1) -> ()
        "rail.terminator"() {kSourceContext = loc("software/templates/src/templates/index/rail/Index.cpp":161:0)} : () -> ()
      }) {kArithSplit = true, kContextType = "kRolled", kName = "LogregTorchSamba.partition_0_0_.ptconvlstm__indexselect@kOutWr", kSourceContext = loc("software/templates/src/templates/index/rail/Index.cpp":161:0), rail.kMetapipeIterCounts = [1], sym_name = "LogregTorchSamba.partition_0_0_.ptconvlstm__indexselect@kOutWr"} : () -> ()
      "rail.context"() ( {
        %4 = "rail.const"() {kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0), kValue = 0 : i64} : () -> ui32
        %5 = "rail.const"() {kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0), kValue = 1 : i64} : () -> ui32
        %6 = "rail.const"() {kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0), kValue = 7 : i64} : () -> ui32
        %7 = "rail.iterator"(%4, %5, %6) {Par = 1 : i32, kChainID = 0 : i64, kIterPos = 0 : i32, kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0)} : (ui32, ui32, ui32) -> ui32
        %8 = "rail.ctrdone"(%7) {kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0)} : (ui32) -> i1
        %9 = "rail.ctxdone"(%8) {kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0)} : (i1) -> i1
        %10 = "rail.const"() {kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0), kValue = 0 : i64} : () -> ui32
        %11 = "rail.const"() {kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0), kValue = 32 : i64} : () -> ui32
        %12 = "rail.const"() {kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0), kValue = 64 : i64} : () -> ui32
        %13 = "rail.iterator"(%10, %11, %12) {Par = -1 : i32, kChainID = 0 : i64, kIterPos = 2 : i32, kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0)} : (ui32, ui32, ui32) -> ui32
        %14 = "rail.const"() {kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0), kValue = 0 : i64} : () -> ui32
        %15 = "rail.const"() {kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0), kValue = 1 : i64} : () -> ui32
        %16 = "rail.const"() {kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0), kValue = 1 : i64} : () -> ui32
        %17 = "rail.iterator"(%14, %15, %16) {Par = 1 : i32, kChainID = 0 : i64, kIterPos = 1 : i32, kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0)} : (ui32, ui32, ui32) -> ui32
        %18 = "rail.const"() {kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0), kValue = 0 : i64} : () -> ui32
        %19 = "rail.const"() {kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0), kValue = 1 : i64} : () -> ui32
        %20 = "rail.const"() {kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0), kValue = 1 : i64} : () -> ui32
        %21 = "rail.iterator"(%18, %19, %20) {Par = 1 : i32, kChainID = 0 : i64, kIterPos = 3 : i32, kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0)} : (ui32, ui32, ui32) -> ui32
        %22 = "rail.const"() {kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0), kValue = 0 : i64} : () -> ui32
        %23 = "rail.sub"(%22, %21) {kInstructionStageType = 2 : i64, kIsArithmetic = true, kIsBinaryOp = true, kIsDataPathOp = true, kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0)} : (ui32, ui32) -> ui32
        "rail.iterchain"(%7, %17, %13, %21) {kChainID = 0 : i64, kName = "addr_chain", kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0)} : (ui32, ui32, ui32, ui32) -> ()
        %24 = "rail.add"(%17, %23) {kInstructionStageType = 2 : i64, kIsArithmetic = true, kIsBinaryOp = true, kIsDataPathOp = true, kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0)} : (ui32, ui32) -> ui32
        %25 = "rail.const"() {kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0), kValue = true} : () -> i1
        %26 = "rail.const"() {kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0), kValue = true} : () -> i1
        %27 = "rail.const"() {kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0), kValue = 0 : i64} : () -> ui32
        ...
        %30 = "rail.const"() {kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0), kValue = 1 : i64} : () -> ui32
        %31 = "rail.less_than"(%24, %30) {kInstructionStageType = 2 : i64, kIsBinaryOp = true, kIsBooleanOp = true, kIsDataPathOp = true, kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0)} : (ui32, ui32) -> i1
        "rail.addr"(%13, %24, %31, %26, %27, %28, %29) {kDim = 2 : i8, kMemOp = false, kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0)} : (ui32, ui32, i1, i1, ui32, ui32, ui32) -> ()
        %32 = "rail.io.control_in"() {kCtxName = "LogregTorchSamba.partition_0_0_.ptconvlstm__dense_layer__linear_wo_bias@kB", kLanes = [], kPortName = "0", kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0), kUnitName = "tbuf2u_0_0_342", sym_name = "0"} : () -> i1
        "rail.inbuf"(%32, %9) {kInit = 2 : i32, kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0)} : (i1, i1) -> ()
        %33 = "rail.io.control_in"() {kCtxName = "LogregTorchSamba.partition_0_0_.ptconvlstm__dense_layer__linear_wo_bias@kB", kLanes = [], kPortName = "1", kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0), kUnitName = "tbuf2u_0_0_342", sym_name = "1"} : () -> i1
        "rail.inbuf"(%33, %9) {kInit = 2 : i32, kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0)} : (i1, i1) -> ()
        %34 = "rail.io.control_out"() {kCtxName = "LogregTorchSamba.partition_0_0_.ptconvlstm__dense_layer__linear_wo_bias@kB", kLanes = [], kPortName = "1000", kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0), kUnitName = "tbuf2u_0_0_342", sym_name = "1000"} : () -> i1
        "rail.send"(%9, %34) {kOpRWPattern1 = "kWriteOperand", kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0)} : (i1, i1) -> ()
        "rail.terminator"() {kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0)} : () -> ()
      }) {kArithSplit = true, kContextType = "kRolled", kName = "LogregTorchSamba.partition_0_0_.ptconvlstm__dense_layer__linear_wo_bias@kB", kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0), rail.kMetapipeIterCounts = [1], sym_name = "LogregTorchSamba.partition_0_0_.ptconvlstm__dense_layer__linear_wo_bias@kB"} : () -> ()
      "rail.terminator"() {kSourceContext = loc("LogregTorchSamba.cpp":957:0)} : () -> ()
    }) {kFIFOMode = false, kName = "tbuf2u_0_0_342", kSourceContext = loc("LogregTorchSamba.cpp":957:0), params = {kDepth = 2 : i64, kLayout = {alignments = [[1, 64]], base_address = 0 : i64, dim_order = [1, 0], format = 9 : i64, shape = [64, 1], vector_transpose = 0 : i64}, kMinMaxCapacitySplit = true, kMinPmus = -1 : i64, kPacingWindow = -1 : i64, kSplitAlgorithm = 0 : i64}, sym_name = "tbuf2u_0_0_342"} : () -> ()
    module_terminator {kSourceContext = loc("LogregTorchSamba.cpp":957:0)}
  }
  %0 = "rail.io.scalar_in"() {kCtxName = "LogregTorchSamba.partition_0_0_.ptconvlstm__indexselect@kLutRd", kLanes = [], kPortName = "idx", kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0), kUnitName = "tbuf2u_0_0_334", sym_name = "tbuf2u_0_0_334_tbuffer_LogregTorchSamba.partition_0_0_.ptconvlstm__indexselect@kLutRd_scalar_in_idx"} : () -> ui32
  %1 = "rail.io.vector_out"() {kCtxName = "LogregTorchSamba.partition_0_0_.ptconvlstm__indexselect@kLutRd", kLanes = [], kPortName = "1001", kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0), kUnitName = "tbuf2u_0_0_334", kVectorLengthInBytes = 64 : i64, sym_name = "tbuf2u_0_0_334_tbuffer_LogregTorchSamba.partition_0_0_.ptconvlstm__indexselect@kLutRd_vector_out_1001"} : () -> vector<32xbf16>
  %2 = "rail.io.scalar_out"() {kCtxName = "LogregTorchSamba.partition_0_0_.ptconvlstm__indexselect@kIndexRd", kLanes = [], kPortName = "1001", kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0), kUnitName = "tbuf1u_0_0_335", sym_name = "tbuf1u_0_0_335_tbuffer_LogregTorchSamba.partition_0_0_.ptconvlstm__indexselect@kIndexRd_scalar_out_1001"} : () -> ui32
  %3 = "rail.io.vector_in"() {kCtxName = "LogregTorchSamba.partition_0_0_.ptconvlstm__indexselect@kOutWr", kLanes = [], kPortName = "8", kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0), kUnitName = "tbuf2u_0_0_342", kVectorLengthInBytes = 64 : i64, sym_name = "tbuf2u_0_0_342_tbuffer_LogregTorchSamba.partition_0_0_.ptconvlstm__indexselect@kOutWr_vector_in_8"} : () -> vector<32xbf16>
  "rail.TConnect"() {kDst = @"tbuf2u_0_0_334_tbuffer_LogregTorchSamba.partition_0_0_.ptconvlstm__indexselect@kLutRd_scalar_in_idx", kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0), kSrc = @"tbuf1u_0_0_335_tbuffer_LogregTorchSamba.partition_0_0_.ptconvlstm__indexselect@kIndexRd_scalar_out_1001"} : () -> ()
  "rail.TConnect"() {kDst = @"tbuf2u_0_0_342_tbuffer_LogregTorchSamba.partition_0_0_.ptconvlstm__indexselect@kOutWr_vector_in_8", kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0), kSrc = @"tbuf2u_0_0_334_tbuffer_LogregTorchSamba.partition_0_0_.ptconvlstm__indexselect@kLutRd_vector_out_1001"} : () -> ()
  "rail.TConnect"() {kDst = @tbuf2u_0_0_334::@tbuf2u_0_0_334::@"LogregTorchSamba.partition_0_0_.ptconvlstm__indexselect@kLutRd"::@"0", kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0), kSrc = @tbuf2u_0_0_342::@tbuf2u_0_0_342::@"LogregTorchSamba.partition_0_0_.ptconvlstm__indexselect@kOutWr"::@"1000"} : () -> ()
  "rail.TConnect"() {kDst = @tbuf2u_0_0_334::@tbuf2u_0_0_334::@"LogregTorchSamba.partition_0_0_.ptconvlstm__indexselect@kLutRd"::@"1", kSourceContext = loc("software/templates/src/templates/gemm/prism/BigGemm.cpp":4221:0), kSrc = @tbuf2u_0_0_342::@tbuf2u_0_0_342::@"LogregTorchSamba.partition_0_0_.ptconvlstm__dense_layer__linear_wo_bias@kB"::@"1000"} : () -> ()
