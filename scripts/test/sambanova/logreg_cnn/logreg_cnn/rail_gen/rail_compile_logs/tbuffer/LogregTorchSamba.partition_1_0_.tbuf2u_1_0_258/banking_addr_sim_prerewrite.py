...
ctxs.append('LogregTorchSamba_partition_1_0__ptconvcnn__lambda_layer__indexselect_recompute__kOutWr')
def LogregTorchSamba_partition_1_0__ptconvcnn__lambda_layer__indexselect_recompute__kOutWr():
    x0 = 64
    x1 = 960
    x2 = True
    x3 = 0
...
ndaddr_funcs['LogregTorchSamba_partition_1_0__ptconvcnn__lambda_layer__indexselect_recompute__kOutWr'] = LogregTorchSamba_partition_1_0__ptconvcnn__lambda_layer__indexselect_recompute__kOutWr
