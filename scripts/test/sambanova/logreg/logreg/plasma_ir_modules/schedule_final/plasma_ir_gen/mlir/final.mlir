module @schedule_0_2 attributes {plasma.kBitfileType = 7 : i64, plasma.kVerbose = false}  {
  plasma.Segment @segment_3() attributes {kChipId = 0 : i64, kIsInputOnly = false, kMemoryLocation = 2 : i64, kPoolId = 0 : i64, kSegmentId = 0 : i64, kSegmentSize = 640 : i64}  {
  ...
  plasma.Segment @segment_2() attributes {kChipId = 0 : i64, kIsInputOnly = true, kMemoryLocation = 2 : i64, kPoolId = 0 : i64, kSegmentId = 1 : i64, kSegmentSize = 2176 : i64}  {
  ...
  plasma.Segment @segment_1() attributes {kChipId = 0 : i64, kIsInputOnly = false, kMemoryLocation = 0 : i64, kPoolId = 0 : i64, kSegmentId = 2 : i64, kSegmentSize = 151104 : i64}  {
  ...
  plasma.Segment @segment_0() attributes {kChipId = 0 : i64, kIsInputOnly = true, kMemoryLocation = 0 : i64, kPoolId = 0 : i64, kSegmentId = 3 : i64, kSegmentSize = 128 : i64}  {
