...
ctxs.append('LogregTorchSamba_partition_0_0__ptconvlstm__lambda_layer__indexselect_kIndexRd')
def LogregTorchSamba_partition_0_0__ptconvlstm__lambda_layer__indexselect_kIndexRd():
    x0 = 3
    x1 = 32
    x2 = 136
    x3 = True
...
ndaddr_funcs['LogregTorchSamba_partition_0_0__ptconvlstm__lambda_layer__indexselect_kIndexRd'] = LogregTorchSamba_partition_0_0__ptconvlstm__lambda_layer__indexselect_kIndexRd
