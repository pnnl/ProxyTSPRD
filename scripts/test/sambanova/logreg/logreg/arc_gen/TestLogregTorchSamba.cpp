...
int main(int argc, char **argv) {
    ...
    std::vector<PlasmaRegion> group_10_tensors {
        {{256, 136, 3}, node_constants::TemplateDataFormats::kBf16(), PhysicalLayout::kRowMajorVectorAligned,  "ptconvlstm__conv_layer__weight", TensorSourceAnnotation::kUserFacing, TensorWeightAnnotation::kWeight, TensorSymbolAnnotation::kMarkNone, {}}        
    };
    ...
    TensorLayout dram_layout_ptconvlstm__conv_layer__weight = group_10.dram_sub_layouts.at(0);
    dram_layout_ptconvlstm__conv_layer__weight.symbol_handle()->die_id = std::nullopt;
    TensorLayout dram_layout_ptconvlstm__conv_layer__weight_0_0_99 = dram_layout_ptconvlstm__conv_layer__weight;
    TensorLayout pmu_layout_ptconvlstm__conv_layer__weight_0_0_99 = group_10.pmu_layouts.at(0);
    TensorLayout dram_layout_ptconvlstm__conv_layer__weight_2_0_185 = dram_layout_ptconvlstm__conv_layer__weight;
    TensorLayout pmu_layout_ptconvlstm__conv_layer__weight_2_0_185 = group_10.pmu_layouts.at(0);
    TensorLayout dram_layout_ptconvlstm__conv_layer__weight__ptconvlstm__conv_layer__reshape_1_bwd_opt_tensor = dram_layout_ptconvlstm__conv_layer__weight;
    TensorLayout pmu_layout_ptconvlstm__conv_layer__weight__ptconvlstm__conv_layer__reshape_1_bwd_opt_tensor = dram_layout_ptconvlstm__conv_layer__weight__ptconvlstm__conv_layer__reshape_1_bwd_opt_tensor.vector_align().at_address(0);
    ...
    TensorLayout dram_layout_ptconvlstm__conv_layer__bias = group_2.dram_sub_layouts.at(0);
    dram_layout_ptconvlstm__conv_layer__bias.symbol_handle()->die_id = std::nullopt;
    TensorLayout dram_layout_ptconvlstm__conv_layer__bias_0_0_110 = dram_layout_ptconvlstm__conv_layer__bias;
    TensorLayout pmu_layout_ptconvlstm__conv_layer__bias_0_0_110 = group_2.pmu_layouts.at(0).vector_align().at_address(0);
    pmu_layout_ptconvlstm__conv_layer__bias_0_0_110.set_vector_transposed(true);
    TensorLayout dram_layout_ptconvlstm__conv_layer__bias_2_0_179 = dram_layout_ptconvlstm__conv_layer__bias;
    TensorLayout pmu_layout_ptconvlstm__conv_layer__bias_2_0_179 = group_2.pmu_layouts.at(0);
    pmu_layout_ptconvlstm__conv_layer__bias_2_0_179.set_vector_transposed(true);
    TensorLayout dram_layout_ptconvlstm__conv_layer__bias__ptconvlstm__conv_layer__conv2d_bwd_opt_tensor = dram_layout_ptconvlstm__conv_layer__bias;
    TensorLayout pmu_layout_ptconvlstm__conv_layer__bias__ptconvlstm__conv_layer__conv2d_bwd_opt_tensor = dram_layout_ptconvlstm__conv_layer__bias__ptconvlstm__conv_layer__conv2d_bwd_opt_tensor.vector_align().at_address(0);
    ...
    TensorLayout dram_layout_ptconvlstm__dense_layer__bias = group_11.dram_sub_layouts.at(0);
    dram_layout_ptconvlstm__dense_layer__bias.symbol_handle()->die_id = std::nullopt;
    TensorLayout dram_layout_ptconvlstm__dense_layer__bias_0_0_115 = dram_layout_ptconvlstm__dense_layer__bias;
    TensorLayout pmu_layout_ptconvlstm__dense_layer__bias_0_0_115 = group_11.pmu_layouts.at(0);
    pmu_layout_ptconvlstm__dense_layer__bias_0_0_115.set_vector_transposed(true);
    TensorLayout dram_layout_ptconvlstm__dense_layer__bias_2_0_173 = dram_layout_ptconvlstm__dense_layer__bias;
    TensorLayout pmu_layout_ptconvlstm__dense_layer__bias_2_0_173 = group_11.pmu_layouts.at(0);
    pmu_layout_ptconvlstm__dense_layer__bias_2_0_173.set_vector_transposed(true);
    ...
    TensorLayout dram_layout_ptconvlstm__dense_layer__weight = group_3.dram_sub_layouts.at(0);
    dram_layout_ptconvlstm__dense_layer__weight.symbol_handle()->die_id = std::nullopt;
    TensorLayout dram_layout_ptconvlstm__dense_layer__weight_0_0_114 = dram_layout_ptconvlstm__dense_layer__weight;
    TensorLayout pmu_layout_ptconvlstm__dense_layer__weight_0_0_114 = group_3.pmu_layouts.at(0);
    pmu_layout_ptconvlstm__dense_layer__weight_0_0_114.set_vector_transposed(true);
    TensorLayout dram_layout_ptconvlstm__dense_layer__weight_1_0_344 = dram_layout_ptconvlstm__dense_layer__weight;
    TensorLayout pmu_layout_ptconvlstm__dense_layer__weight_1_0_344 = group_3.pmu_layouts.at(0);
    pmu_layout_ptconvlstm__dense_layer__weight_1_0_344.set_vector_transposed(true);
    TensorLayout dram_layout_ptconvlstm__dense_layer__weight_2_0_167 = dram_layout_ptconvlstm__dense_layer__weight;
    TensorLayout pmu_layout_ptconvlstm__dense_layer__weight_2_0_167 = group_3.pmu_layouts.at(0);
    pmu_layout_ptconvlstm__dense_layer__weight_2_0_167.set_vector_transposed(true);
    ...
    TensorLayout dram_layout_ptconvlstm__criterion__mseloss__outputs__0__grad_1_0_135 = dram_layout_ptconvlstm__criterion__mseloss__outputs__0__grad;
    TensorLayout pmu_layout_ptconvlstm__criterion__mseloss__outputs__0__grad_1_0_135 = dram_layout_ptconvlstm__criterion__mseloss__outputs__0__grad_1_0_135.vector_align().at_address(0);
    ...
    TensorLayout dram_layout_ptconvlstm__view__outputs__0__grad_1_0_269 = dram_layout_ptconvlstm__view__outputs__0__grad;
    TensorLayout pmu_layout_ptconvlstm__view__outputs__0__grad_1_0_269 = dram_layout_ptconvlstm__view__outputs__0__grad_1_0_269.with_logical_shape({30, 136}).align({{-2,64}}).at_address(0);
    pmu_layout_ptconvlstm__view__outputs__0__grad_1_0_269.set_vector_transposed(false);
    TensorLayout pmu_layout_ptconvlstm__view__outputs__0__grad_1_0_269_full = pmu_layout_ptconvlstm__view__outputs__0__grad_1_0_269.supertensor({1}).at_address(0);
    pmu_layout_ptconvlstm__view__outputs__0__grad_1_0_269_full.set_vector_transposed(false);
    ...
    TensorLayout dram_layout_ptconvlstm__dense_layer__weight__sgd0__momentum = group_12.dram_sub_layouts.at(0);
    dram_layout_ptconvlstm__dense_layer__weight__sgd0__momentum.symbol_handle()->die_id = std::nullopt;
    TensorLayout dram_layout_ptconvlstm__dense_layer__weight__sgd0__momentum_2_0_169 = dram_layout_ptconvlstm__dense_layer__weight__sgd0__momentum;
    TensorLayout pmu_layout_ptconvlstm__dense_layer__weight__sgd0__momentum_2_0_169 = group_12.pmu_layouts.at(0);
    pmu_layout_ptconvlstm__dense_layer__weight__sgd0__momentum_2_0_169.set_vector_transposed(true);
    ...
    TensorLayout dram_layout_ptconvlstm__dense_layer__bias__sgd0__momentum = group_13.dram_sub_layouts.at(0);
    dram_layout_ptconvlstm__dense_layer__bias__sgd0__momentum.symbol_handle()->die_id = std::nullopt;
    TensorLayout dram_layout_ptconvlstm__dense_layer__bias__sgd0__momentum_2_0_175 = dram_layout_ptconvlstm__dense_layer__bias__sgd0__momentum;
    TensorLayout pmu_layout_ptconvlstm__dense_layer__bias__sgd0__momentum_2_0_175 = group_13.pmu_layouts.at(0);
    pmu_layout_ptconvlstm__dense_layer__bias__sgd0__momentum_2_0_175.set_vector_transposed(true);
    ...
    TensorLayout dram_layout_ptconvlstm__conv_layer__bias__sgd0__momentum = group_13.dram_sub_layouts.at(1);
    dram_layout_ptconvlstm__conv_layer__bias__sgd0__momentum.symbol_handle()->die_id = std::nullopt;
    TensorLayout dram_layout_ptconvlstm__conv_layer__bias__sgd0__momentum_2_0_181 = dram_layout_ptconvlstm__conv_layer__bias__sgd0__momentum;
    TensorLayout pmu_layout_ptconvlstm__conv_layer__bias__sgd0__momentum_2_0_181 = group_13.pmu_layouts.at(1);
    pmu_layout_ptconvlstm__conv_layer__bias__sgd0__momentum_2_0_181.set_vector_transposed(true);
    TensorLayout dram_layout_ptconvlstm__conv_layer__bias__ptconvlstm__conv_layer__conv2d_bwd_opt_tensor1 = dram_layout_ptconvlstm__conv_layer__bias__sgd0__momentum;
    TensorLayout pmu_layout_ptconvlstm__conv_layer__bias__ptconvlstm__conv_layer__conv2d_bwd_opt_tensor1 = dram_layout_ptconvlstm__conv_layer__bias__ptconvlstm__conv_layer__conv2d_bwd_opt_tensor1.vector_align().at_address(0);
    TensorLayout dram_layout_ptconvlstm__conv_layer__weight__sgd0__momentum = group_13.dram_sub_layouts.at(2);
    dram_layout_ptconvlstm__conv_layer__weight__sgd0__momentum.symbol_handle()->die_id = std::nullopt;
    TensorLayout dram_layout_ptconvlstm__conv_layer__weight__sgd0__momentum_2_0_187 = dram_layout_ptconvlstm__conv_layer__weight__sgd0__momentum;
    TensorLayout pmu_layout_ptconvlstm__conv_layer__weight__sgd0__momentum_2_0_187 = group_13.pmu_layouts.at(2);
    TensorLayout dram_layout_ptconvlstm__conv_layer__weight__ptconvlstm__conv_layer__reshape_1_bwd_opt_tensor1 = dram_layout_ptconvlstm__conv_layer__weight__sgd0__momentum;
    TensorLayout pmu_layout_ptconvlstm__conv_layer__weight__ptconvlstm__conv_layer__reshape_1_bwd_opt_tensor1 = dram_layout_ptconvlstm__conv_layer__weight__ptconvlstm__conv_layer__reshape_1_bwd_opt_tensor1.vector_align().at_address(0);
    ...
    TensorLayout dram_layout_ptconvlstm__conv_layer__reshape_20_used_by_ptconvlstm__dense_layer__linear_bwd_weight_1_0_272 = dram_layout_ptconvlstm__conv_layer__reshape_20_used_by_ptconvlstm__dense_layer__linear_bwd_weight;
    TensorLayout pmu_layout_ptconvlstm__conv_layer__reshape_20_used_by_ptconvlstm__dense_layer__linear_bwd_weight_1_0_272 = dram_layout_ptconvlstm__conv_layer__reshape_20_used_by_ptconvlstm__dense_layer__linear_bwd_weight_1_0_272.with_logical_shape({256, 1}).vector_align().at_address(0);
    pmu_layout_ptconvlstm__conv_layer__reshape_20_used_by_ptconvlstm__dense_layer__linear_bwd_weight_1_0_272.set_vector_transposed(true);
    TensorLayout pmu_layout_ptconvlstm__conv_layer__reshape_20_used_by_ptconvlstm__dense_layer__linear_bwd_weight_1_0_272_full = pmu_layout_ptconvlstm__conv_layer__reshape_20_used_by_ptconvlstm__dense_layer__linear_bwd_weight_1_0_272.supertensor({1}).at_address(0);
    pmu_layout_ptconvlstm__conv_layer__reshape_20_used_by_ptconvlstm__dense_layer__linear_bwd_weight_1_0_272_full.set_vector_transposed(false);
    
    TensorLayout dram_layout_ptconvlstm__conv_layer__reshape_20_used_by_ptconvlstm__dense_layer__linear_bwd_weight_0_0_274 = dram_layout_ptconvlstm__conv_layer__reshape_20_used_by_ptconvlstm__dense_layer__linear_bwd_weight;
    TensorLayout pmu_layout_ptconvlstm__conv_layer__reshape_20_used_by_ptconvlstm__dense_layer__linear_bwd_weight_0_0_274 = dram_layout_ptconvlstm__conv_layer__reshape_20_used_by_ptconvlstm__dense_layer__linear_bwd_weight_0_0_274.with_logical_shape({256, 1}).vector_align().at_address(0);
    TensorLayout pmu_layout_ptconvlstm__conv_layer__reshape_20_used_by_ptconvlstm__dense_layer__linear_bwd_weight_0_0_274_full = pmu_layout_ptconvlstm__conv_layer__reshape_20_used_by_ptconvlstm__dense_layer__linear_bwd_weight_0_0_274.supertensor({1}).at_address(0);
    pmu_layout_ptconvlstm__conv_layer__reshape_20_used_by_ptconvlstm__dense_layer__linear_bwd_weight_0_0_274_full.set_vector_transposed(false);
    ...
    TensorLayout dram_layout_ptconvlstm__reshape0_used_by_ptconvlstm__criterion__mseloss_bwd_sub_1_0_271 = dram_layout_ptconvlstm__reshape0_used_by_ptconvlstm__criterion__mseloss_bwd_sub;
    TensorLayout pmu_layout_ptconvlstm__reshape0_used_by_ptconvlstm__criterion__mseloss_bwd_sub_1_0_271 = dram_layout_ptconvlstm__reshape0_used_by_ptconvlstm__criterion__mseloss_bwd_sub_1_0_271.with_logical_shape({4080}).vector_align().at_address(0);
    pmu_layout_ptconvlstm__reshape0_used_by_ptconvlstm__criterion__mseloss_bwd_sub_1_0_271.set_vector_transposed(false);
    TensorLayout pmu_layout_ptconvlstm__reshape0_used_by_ptconvlstm__criterion__mseloss_bwd_sub_1_0_271_full = pmu_layout_ptconvlstm__reshape0_used_by_ptconvlstm__criterion__mseloss_bwd_sub_1_0_271.supertensor({1}).at_address(0);
    pmu_layout_ptconvlstm__reshape0_used_by_ptconvlstm__criterion__mseloss_bwd_sub_1_0_271_full.set_vector_transposed(false);
    
    TensorLayout dram_layout_ptconvlstm__reshape0_used_by_ptconvlstm__criterion__mseloss_bwd_sub_0_0_275 = dram_layout_ptconvlstm__reshape0_used_by_ptconvlstm__criterion__mseloss_bwd_sub;
    TensorLayout pmu_layout_ptconvlstm__reshape0_used_by_ptconvlstm__criterion__mseloss_bwd_sub_0_0_275 = dram_layout_ptconvlstm__reshape0_used_by_ptconvlstm__criterion__mseloss_bwd_sub_0_0_275.with_logical_shape({4080}).vector_align().at_address(0);
    TensorLayout pmu_layout_ptconvlstm__reshape0_used_by_ptconvlstm__criterion__mseloss_bwd_sub_0_0_275_full = pmu_layout_ptconvlstm__reshape0_used_by_ptconvlstm__criterion__mseloss_bwd_sub_0_0_275.supertensor({1}).at_address(0);
    pmu_layout_ptconvlstm__reshape0_used_by_ptconvlstm__criterion__mseloss_bwd_sub_0_0_275_full.set_vector_transposed(false);
    ...
    TensorLayout dram_layout_ptconvlstm__dense_layer__weight__grad = group_14.dram_sub_layouts.at(0);
    dram_layout_ptconvlstm__dense_layer__weight__grad.symbol_handle()->die_id = std::nullopt;
    TensorLayout dram_layout_ptconvlstm__dense_layer__weight__grad_2_0_168 = dram_layout_ptconvlstm__dense_layer__weight__grad;
    TensorLayout pmu_layout_ptconvlstm__dense_layer__weight__grad_2_0_168 = group_14.pmu_layouts.at(0);
    pmu_layout_ptconvlstm__dense_layer__weight__grad_2_0_168.set_vector_transposed(true);
    ...
    std::vector<PlasmaRegion> group_15_tensors {
        ...
        {{256, 136, 3}, node_constants::TemplateDataFormats::kBf16(), PhysicalLayout::kRowMajorVectorAligned,  "ptconvlstm__conv_layer__weight__grad", TensorSourceAnnotation::kUserFacing, TensorWeightAnnotation::kNonWeight, TensorSymbolAnnotation::kMarkNone, {}}        
    };
    ...
    TensorLayout dram_layout_ptconvlstm__dense_layer__bias__grad = group_15.dram_sub_layouts.at(0);
    dram_layout_ptconvlstm__dense_layer__bias__grad.symbol_handle()->die_id = std::nullopt;
    TensorLayout dram_layout_ptconvlstm__dense_layer__bias__grad_2_0_174 = dram_layout_ptconvlstm__dense_layer__bias__grad;
    TensorLayout pmu_layout_ptconvlstm__dense_layer__bias__grad_2_0_174 = group_15.pmu_layouts.at(0);
    pmu_layout_ptconvlstm__dense_layer__bias__grad_2_0_174.set_vector_transposed(true);
    ...
    TensorLayout dram_layout_ptconvlstm__conv_layer__bias__grad = group_15.dram_sub_layouts.at(1);
    dram_layout_ptconvlstm__conv_layer__bias__grad.symbol_handle()->die_id = std::nullopt;
    TensorLayout dram_layout_ptconvlstm__conv_layer__bias__grad_2_0_180 = dram_layout_ptconvlstm__conv_layer__bias__grad;
    TensorLayout pmu_layout_ptconvlstm__conv_layer__bias__grad_2_0_180 = group_15.pmu_layouts.at(1);
    pmu_layout_ptconvlstm__conv_layer__bias__grad_2_0_180.set_vector_transposed(true);
    ...
    TensorLayout dram_layout_ptconvlstm__conv_layer__weight__grad = group_15.dram_sub_layouts.at(2);
    dram_layout_ptconvlstm__conv_layer__weight__grad.symbol_handle()->die_id = std::nullopt;
    TensorLayout dram_layout_ptconvlstm__conv_layer__weight__grad_2_0_186 = dram_layout_ptconvlstm__conv_layer__weight__grad;
    TensorLayout pmu_layout_ptconvlstm__conv_layer__weight__grad_2_0_186 = group_15.pmu_layouts.at(2);
    ...
    TensorLayout dram_layout_ptconvlstm__conv_layer__conv2d_conv_fwd_stream0__gather_list_0_0_386 = dram_layout_ptconvlstm__conv_layer__conv2d_conv_fwd_stream0__gather_list;
    TensorLayout pmu_layout_ptconvlstm__conv_layer__conv2d_conv_fwd_stream0__gather_list_0_0_386 = dram_layout_ptconvlstm__conv_layer__conv2d_conv_fwd_stream0__gather_list_0_0_386.vector_align().at_address(0);
    /// Input Group #17
    ...
    TensorLayout dram_layout_ptconvlstm__conv_layer__conv2d_bwd_conv_grad_stream0_kernel0__gather_list = group_17.dram_sub_layouts.at(1);
    ...
    TensorLayout dram_layout_ptconvlstm__conv_layer__conv2d_bwd_conv_grad_stream0_kernel0__gather_list_1_0_388 = dram_layout_ptconvlstm__conv_layer__conv2d_bwd_conv_grad_stream0_kernel0__gather_list;
    TensorLayout pmu_layout_ptconvlstm__conv_layer__conv2d_bwd_conv_grad_stream0_kernel0__gather_list_1_0_388 = group_17.pmu_layouts.at(1);
    ...
    TensorLayout dram_layout_ptconvlstm__view__outputs__0_0_0_276 = dram_layout_ptconvlstm__view__outputs__0;
    TensorLayout pmu_layout_ptconvlstm__view__outputs__0_0_0_276 = dram_layout_ptconvlstm__view__outputs__0_0_0_276.with_logical_shape({30, 136}).align({{-2,64}}).at_address(0);
    TensorLayout pmu_layout_ptconvlstm__view__outputs__0_0_0_276_full = pmu_layout_ptconvlstm__view__outputs__0_0_0_276.supertensor({1}).at_address(0);
    pmu_layout_ptconvlstm__view__outputs__0_0_0_276_full.set_vector_transposed(false);
    ...
    plasma.workspace().add_section_call(0, {
        {
            {dram_layout_ptconvlstm__conv_layer__weight.symbol_handle(), true}            ,
            {dram_layout_inp_window_slice_1.symbol_handle(), true}            ,
            {dram_layout_ptconvlstm__conv_layer__bias.symbol_handle(), true}            ,
            {dram_layout_group_3.symbol_handle(), true}            ,
            {dram_layout_group_11.symbol_handle(), true}            ,
            {dram_layout_inp_window.symbol_handle(), true}            ,
            {dram_layout_ptconvlstm__conv_layer__conv2d_conv_fwd_stream0__gather_list.symbol_handle(), true}            ,
            {dram_layout_out_window.symbol_handle(), true}            ,
            {dram_layout_ptconvlstm__conv_layer__reshape_20_used_by_ptconvlstm__dense_layer__linear_bwd_weight.symbol_handle(), false}            ,
            {dram_layout_ptconvlstm__reshape0_used_by_ptconvlstm__criterion__mseloss_bwd_sub.symbol_handle(), false}            ,
    ...
    plasma.workspace().add_section_call(1, {
        {
            ...
            {dram_layout_out_window.symbol_handle(), true}            ,
            {dram_layout_ptconvlstm__reshape0_used_by_ptconvlstm__criterion__mseloss_bwd_sub.symbol_handle(), true}            ,
            {dram_layout_ptconvlstm__dense_layer__weight.symbol_handle(), true}            ,
            {dram_layout_ptconvlstm__conv_layer__reshape_20_used_by_ptconvlstm__dense_layer__linear_bwd_weight.symbol_handle(), true}            ,
            {dram_layout_inp_window.symbol_handle(), true}            ,
            ...
            {dram_layout_ptconvlstm__conv_layer__bias__grad.symbol_handle(), false}            ,
            {dram_layout_ptconvlstm__conv_layer__weight__grad.symbol_handle(), false}            
        }        
        }, true);
    ...
    params.ptconvlstm__conv_layer__weight_0_0_99 = pmu_layout_ptconvlstm__conv_layer__weight_0_0_99;
    params.ptconvlstm__conv_layer__weight_2_0_185 = pmu_layout_ptconvlstm__conv_layer__weight_2_0_185;
    ...
    params.ptconvlstm__conv_layer__bias_0_0_110 = pmu_layout_ptconvlstm__conv_layer__bias_0_0_110;
    params.ptconvlstm__conv_layer__bias_2_0_179 = pmu_layout_ptconvlstm__conv_layer__bias_2_0_179;
    params.ptconvlstm__conv_layer__bias_dram_in = dram_layout_ptconvlstm__conv_layer__bias;
    params.ptconvlstm__dense_layer__bias_0_0_115 = pmu_layout_ptconvlstm__dense_layer__bias_0_0_115;
    params.ptconvlstm__dense_layer__bias_2_0_173 = pmu_layout_ptconvlstm__dense_layer__bias_2_0_173;
    params.ptconvlstm__dense_layer__bias_dram_in = dram_layout_ptconvlstm__dense_layer__bias;
    params.ptconvlstm__dense_layer__weight_0_0_114 = pmu_layout_ptconvlstm__dense_layer__weight_0_0_114;
    params.ptconvlstm__dense_layer__weight_1_0_344 = pmu_layout_ptconvlstm__dense_layer__weight_1_0_344;
    params.ptconvlstm__dense_layer__weight_2_0_167 = pmu_layout_ptconvlstm__dense_layer__weight_2_0_167;
    ...
    params.ptconvlstm__criterion__mseloss__outputs__0__grad_1_0_135 = pmu_layout_ptconvlstm__criterion__mseloss__outputs__0__grad_1_0_135;
    ...
    params.ptconvlstm__view__outputs__0__grad_1_0_269 = pmu_layout_ptconvlstm__view__outputs__0__grad_1_0_269;
    params.ptconvlstm__view__outputs__0__grad_dram_in = dram_layout_ptconvlstm__view__outputs__0__grad;
    params.ptconvlstm__dense_layer__weight__sgd0__momentum_2_0_169 = pmu_layout_ptconvlstm__dense_layer__weight__sgd0__momentum_2_0_169;
    ...
    params.ptconvlstm__dense_layer__bias__sgd0__momentum_2_0_175 = pmu_layout_ptconvlstm__dense_layer__bias__sgd0__momentum_2_0_175;
    params.ptconvlstm__dense_layer__bias__sgd0__momentum_dram_in = dram_layout_ptconvlstm__dense_layer__bias__sgd0__momentum;
    params.ptconvlstm__conv_layer__bias__sgd0__momentum_2_0_181 = pmu_layout_ptconvlstm__conv_layer__bias__sgd0__momentum_2_0_181;
    params.ptconvlstm__conv_layer__bias__sgd0__momentum_dram_in = dram_layout_ptconvlstm__conv_layer__bias__sgd0__momentum;
    params.ptconvlstm__conv_layer__weight__sgd0__momentum_2_0_187 = pmu_layout_ptconvlstm__conv_layer__weight__sgd0__momentum_2_0_187;
    params.ptconvlstm__conv_layer__weight__sgd0__momentum_dram_in = dram_layout_ptconvlstm__conv_layer__weight__sgd0__momentum;
    params.ptconvlstm__conv_layer__reshape_20_used_by_ptconvlstm__dense_layer__linear_bwd_weight_1_0_272 = pmu_layout_ptconvlstm__conv_layer__reshape_20_used_by_ptconvlstm__dense_layer__linear_bwd_weight_1_0_272;
    ...
    params.ptconvlstm__reshape0_used_by_ptconvlstm__criterion__mseloss_bwd_sub_1_0_271 = pmu_layout_ptconvlstm__reshape0_used_by_ptconvlstm__criterion__mseloss_bwd_sub_1_0_271;
    ...
    params.ptconvlstm__dense_layer__weight__grad_2_0_168 = pmu_layout_ptconvlstm__dense_layer__weight__grad_2_0_168;
    params.ptconvlstm__dense_layer__weight__grad_dram_in = dram_layout_ptconvlstm__dense_layer__weight__grad;
    params.ptconvlstm__dense_layer__bias__grad_2_0_174 = pmu_layout_ptconvlstm__dense_layer__bias__grad_2_0_174;
    params.ptconvlstm__dense_layer__bias__grad_dram_in = dram_layout_ptconvlstm__dense_layer__bias__grad;
    params.ptconvlstm__conv_layer__bias__grad_2_0_180 = pmu_layout_ptconvlstm__conv_layer__bias__grad_2_0_180;
    params.ptconvlstm__conv_layer__bias__grad_dram_in = dram_layout_ptconvlstm__conv_layer__bias__grad;
    params.ptconvlstm__conv_layer__weight__grad_2_0_186 = pmu_layout_ptconvlstm__conv_layer__weight__grad_2_0_186;
    params.ptconvlstm__conv_layer__weight__grad_dram_in = dram_layout_ptconvlstm__conv_layer__weight__grad;
    params.ptconvlstm__conv_layer__conv2d_conv_fwd_stream0__gather_list_0_0_386 = pmu_layout_ptconvlstm__conv_layer__conv2d_conv_fwd_stream0__gather_list_0_0_386;
    ...
    params.ptconvlstm__conv_layer__conv2d_bwd_conv_grad_stream0_kernel0__gather_list_1_0_388 = pmu_layout_ptconvlstm__conv_layer__conv2d_bwd_conv_grad_stream0_kernel0__gather_list_1_0_388;
    ...
    auto section0_fn = [&](Plasma &section_plasma, SectionId section_id) {    
        ...
        { // Begin Section 0, Chip 0
            ...
            fronting_pmu_load_group_10_params.dram_layout_all = dram_layout_ptconvlstm__conv_layer__weight_0_0_99;
            ...
            /// Load Input ptconvlstm__conv_layer__bias_0_0_110
            DramInput dram_input_ptconvlstm__conv_layer__bias_0_0_110;
            DramLoadParams ptconvlstm__conv_layer__bias_0_0_110_load_params;
            dram_input_ptconvlstm__conv_layer__bias_0_0_110.dram_layout = dram_layout_ptconvlstm__conv_layer__bias_0_0_110;
            dram_input_ptconvlstm__conv_layer__bias_0_0_110.pmu_layout = pmu_layout_ptconvlstm__conv_layer__bias_0_0_110;
            ptconvlstm__conv_layer__bias_0_0_110_load_params.load_once = false;
            ptconvlstm__conv_layer__bias_0_0_110_load_params.vector_transpose = false;
            dram_input_ptconvlstm__conv_layer__bias_0_0_110.sinks = node.input_list(arc::LogregTorchSamba::Input::kptconvlstm__conv_layer__bias_0_0_110);
            dram_input_ptconvlstm__conv_layer__bias_0_0_110.params = ptconvlstm__conv_layer__bias_0_0_110_load_params;
            dram_input_ptconvlstm__conv_layer__bias_0_0_110.is_lut = false;
            dram_input_ptconvlstm__conv_layer__bias_0_0_110.group_id = 0;
            dram_input_ptconvlstm__conv_layer__bias_0_0_110.timing_group = std::make_pair(TimingGroup::kInitGroup, 1);
            loads.push_back(dram_input_ptconvlstm__conv_layer__bias_0_0_110);
            ...
            std::vector<BufferNode *> gbufs_load_group_3 {
                node.wbuf_in(arc::LogregTorchSamba::Input::kptconvlstm__dense_layer__weight_0_0_114)                
            };
            ...
            std::vector<BufferNode *> gbufs_load_group_11 {
                node.wbuf_in(arc::LogregTorchSamba::Input::kptconvlstm__dense_layer__bias_0_0_115)                
            };
            ...
            fronting_pmu_load_group_16_params.dram_layout_all = dram_layout_ptconvlstm__conv_layer__conv2d_conv_fwd_stream0__gather_list_0_0_386;
            ...
            /// Store Group #20;
            BackingPmu::Params backing_pmu_group_20_ptconvlstm__conv_layer__reshape_20_used_by_ptconvlstm__dense_layer__linear_bwd_weight_0_0_274_params;
            backing_pmu_group_20_ptconvlstm__conv_layer__reshape_20_used_by_ptconvlstm__dense_layer__linear_bwd_weight_0_0_274_params.host_fifo_use = false;
            backing_pmu_group_20_ptconvlstm__conv_layer__reshape_20_used_by_ptconvlstm__dense_layer__linear_bwd_weight_0_0_274_params.dram_layout_all = dram_layout_ptconvlstm__conv_layer__reshape_20_used_by_ptconvlstm__dense_layer__linear_bwd_weight_0_0_274;
            auto buffer_node_ptconvlstm__conv_layer__reshape_20_used_by_ptconvlstm__dense_layer__linear_bwd_weight_0_0_274 = static_cast<BufferNode *>(node.get_node(arc::LogregTorchSamba::NodeEnum::kgbuf2a_0_0_397));
            backing_pmu_group_20_ptconvlstm__conv_layer__reshape_20_used_by_ptconvlstm__dense_layer__linear_bwd_weight_0_0_274_params.buffer_node = buffer_node_ptconvlstm__conv_layer__reshape_20_used_by_ptconvlstm__dense_layer__linear_bwd_weight_0_0_274;
            auto *backing_pmu_group_20_ptconvlstm__conv_layer__reshape_20_used_by_ptconvlstm__dense_layer__linear_bwd_weight_0_0_274 = section_plasma.create_node<BackingPmu>("s0.backing_pmu_group_20_ptconvlstm__conv_layer__reshape_20_used_by_ptconvlstm__dense_layer__linear_bwd_weight_0_0_274", partition_parent, &section_plasma, backing_pmu_group_20_ptconvlstm__conv_layer__reshape_20_used_by_ptconvlstm__dense_layer__linear_bwd_weight_0_0_274_params);
            backing_pmu_group_20_ptconvlstm__conv_layer__reshape_20_used_by_ptconvlstm__dense_layer__linear_bwd_weight_0_0_274->configure_node();
            backing_pmu_group_20_ptconvlstm__conv_layer__reshape_20_used_by_ptconvlstm__dense_layer__linear_bwd_weight_0_0_274->configure_dram_store(stores, /*multi_reverse*/false, /*multi_reverse_group_size*/0);
            stores.back().timing_group = std::make_pair(TimingGroup::kFinalGroup, 1);
            
            /// Store Group #21;
            BackingPmu::Params backing_pmu_group_21_ptconvlstm__reshape0_used_by_ptconvlstm__criterion__mseloss_bwd_sub_0_0_275_params;
            backing_pmu_group_21_ptconvlstm__reshape0_used_by_ptconvlstm__criterion__mseloss_bwd_sub_0_0_275_params.host_fifo_use = false;
            backing_pmu_group_21_ptconvlstm__reshape0_used_by_ptconvlstm__criterion__mseloss_bwd_sub_0_0_275_params.dram_layout_all = dram_layout_ptconvlstm__reshape0_used_by_ptconvlstm__criterion__mseloss_bwd_sub_0_0_275;
            auto buffer_node_ptconvlstm__reshape0_used_by_ptconvlstm__criterion__mseloss_bwd_sub_0_0_275 = static_cast<BufferNode *>(node.get_node(arc::LogregTorchSamba::NodeEnum::kgbuf2a_0_0_441));
            backing_pmu_group_21_ptconvlstm__reshape0_used_by_ptconvlstm__criterion__mseloss_bwd_sub_0_0_275_params.buffer_node = buffer_node_ptconvlstm__reshape0_used_by_ptconvlstm__criterion__mseloss_bwd_sub_0_0_275;
            auto *backing_pmu_group_21_ptconvlstm__reshape0_used_by_ptconvlstm__criterion__mseloss_bwd_sub_0_0_275 = section_plasma.create_node<BackingPmu>("s0.backing_pmu_group_21_ptconvlstm__reshape0_used_by_ptconvlstm__criterion__mseloss_bwd_sub_0_0_275", partition_parent, &section_plasma, backing_pmu_group_21_ptconvlstm__reshape0_used_by_ptconvlstm__criterion__mseloss_bwd_sub_0_0_275_params);
            backing_pmu_group_21_ptconvlstm__reshape0_used_by_ptconvlstm__criterion__mseloss_bwd_sub_0_0_275->configure_node();
            backing_pmu_group_21_ptconvlstm__reshape0_used_by_ptconvlstm__criterion__mseloss_bwd_sub_0_0_275->configure_dram_store(stores, /*multi_reverse*/false, /*multi_reverse_group_size*/0);
            stores.back().timing_group = std::make_pair(TimingGroup::kFinalGroup, 1);
            
            /// Store Group #22;
            BackingPmu::Params backing_pmu_group_22_ptconvlstm__view__outputs__0_0_0_276_params;
            backing_pmu_group_22_ptconvlstm__view__outputs__0_0_0_276_params.host_fifo_use = false;
            backing_pmu_group_22_ptconvlstm__view__outputs__0_0_0_276_params.dram_layout_all = dram_layout_ptconvlstm__view__outputs__0_0_0_276;
            auto buffer_node_ptconvlstm__view__outputs__0_0_0_276 = static_cast<BufferNode *>(node.get_node(arc::LogregTorchSamba::NodeEnum::kgbuf2a_0_0_399));
            backing_pmu_group_22_ptconvlstm__view__outputs__0_0_0_276_params.buffer_node = buffer_node_ptconvlstm__view__outputs__0_0_0_276;
            auto *backing_pmu_group_22_ptconvlstm__view__outputs__0_0_0_276 = section_plasma.create_node<BackingPmu>("s0.backing_pmu_group_22_ptconvlstm__view__outputs__0_0_0_276", partition_parent, &section_plasma, backing_pmu_group_22_ptconvlstm__view__outputs__0_0_0_276_params);
            backing_pmu_group_22_ptconvlstm__view__outputs__0_0_0_276->configure_node();
            backing_pmu_group_22_ptconvlstm__view__outputs__0_0_0_276->configure_dram_store(stores, /*multi_reverse*/false, /*multi_reverse_group_size*/0);
            stores.back().timing_group = std::make_pair(TimingGroup::kFinalGroup, 1);
    ...
    auto section1_fn = [&](Plasma &section_plasma, SectionId section_id) {    
        ...
        { // Begin Section 1, Chip 0
            ...
            /** DRAM Loads **/
            std::vector<DramInput> loads;
            /// Load Input ptconvlstm__criterion__mseloss__outputs__0__grad_1_0_135
            DramInput dram_input_ptconvlstm__criterion__mseloss__outputs__0__grad_1_0_135;
            DramLoadParams ptconvlstm__criterion__mseloss__outputs__0__grad_1_0_135_load_params;
            dram_input_ptconvlstm__criterion__mseloss__outputs__0__grad_1_0_135.dram_layout = dram_layout_ptconvlstm__criterion__mseloss__outputs__0__grad_1_0_135;
            dram_input_ptconvlstm__criterion__mseloss__outputs__0__grad_1_0_135.pmu_layout = pmu_layout_ptconvlstm__criterion__mseloss__outputs__0__grad_1_0_135;
            ptconvlstm__criterion__mseloss__outputs__0__grad_1_0_135_load_params.load_once = false;
            ptconvlstm__criterion__mseloss__outputs__0__grad_1_0_135_load_params.vector_transpose = false;
            dram_input_ptconvlstm__criterion__mseloss__outputs__0__grad_1_0_135.sinks = node.input_list(arc::LogregTorchSamba::Input::kptconvlstm__criterion__mseloss__outputs__0__grad_1_0_135);
            dram_input_ptconvlstm__criterion__mseloss__outputs__0__grad_1_0_135.params = ptconvlstm__criterion__mseloss__outputs__0__grad_1_0_135_load_params;
            dram_input_ptconvlstm__criterion__mseloss__outputs__0__grad_1_0_135.is_lut = false;
            dram_input_ptconvlstm__criterion__mseloss__outputs__0__grad_1_0_135.group_id = 0;
            dram_input_ptconvlstm__criterion__mseloss__outputs__0__grad_1_0_135.timing_group = std::make_pair(TimingGroup::kInitGroup, 1);
            loads.push_back(dram_input_ptconvlstm__criterion__mseloss__outputs__0__grad_1_0_135);
            ...
            fronting_pmu_load_group_26_params.dram_layout_all = dram_layout_ptconvlstm__view__outputs__0__grad_1_0_269;
            ...
            fronting_pmu_load_group_28_params.dram_layout_all = dram_layout_ptconvlstm__reshape0_used_by_ptconvlstm__criterion__mseloss_bwd_sub_1_0_271;
            ...
            fronting_pmu_load_group_29_params.dram_layout_all = dram_layout_ptconvlstm__dense_layer__weight_1_0_344;
            ...
            fronting_pmu_load_group_30_params.dram_layout_all = dram_layout_ptconvlstm__conv_layer__reshape_20_used_by_ptconvlstm__dense_layer__linear_bwd_weight_1_0_272;
            ...
            std::vector<DramOutput> stores;
            /// Store Group #32;
            BackingPmu::Params backing_pmu_group_32_ptconvlstm__dense_layer__linear_bwd_weight_tensor_params;
            backing_pmu_group_32_ptconvlstm__dense_layer__linear_bwd_weight_tensor_params.host_fifo_use = false;
            backing_pmu_group_32_ptconvlstm__dense_layer__linear_bwd_weight_tensor_params.dram_layout_all = dram_layout_ptconvlstm__dense_layer__linear_bwd_weight_tensor;
            ...
            backing_pmu_group_32_ptconvlstm__dense_layer__linear_bwd_weight_tensor_params.buffer_node = buffer_node_ptconvlstm__dense_layer__linear_bwd_weight_tensor;
            auto *backing_pmu_group_32_ptconvlstm__dense_layer__linear_bwd_weight_tensor = section_plasma.create_node<BackingPmu>("s1.backing_pmu_group_32_ptconvlstm__dense_layer__linear_bwd_weight_tensor", partition_parent, &section_plasma, backing_pmu_group_32_ptconvlstm__dense_layer__linear_bwd_weight_tensor_params);
            backing_pmu_group_32_ptconvlstm__dense_layer__linear_bwd_weight_tensor->configure_node();
            backing_pmu_group_32_ptconvlstm__dense_layer__linear_bwd_weight_tensor->configure_dram_store(stores, /*multi_reverse*/false, /*multi_reverse_group_size*/0);
            stores.back().timing_group = std::make_pair(TimingGroup::kFinalGroup, 1);
            
            /// Store Group #33;
            BackingPmu::Params backing_pmu_group_33_ptconvlstm__dense_layer__linear_bwd_weight_tensor1_params;
            backing_pmu_group_33_ptconvlstm__dense_layer__linear_bwd_weight_tensor1_params.host_fifo_use = false;
            backing_pmu_group_33_ptconvlstm__dense_layer__linear_bwd_weight_tensor1_params.dram_layout_all = dram_layout_ptconvlstm__dense_layer__linear_bwd_weight_tensor1;
            ...
            backing_pmu_group_33_ptconvlstm__dense_layer__linear_bwd_weight_tensor1_params.buffer_node = buffer_node_ptconvlstm__dense_layer__linear_bwd_weight_tensor1;
            auto *backing_pmu_group_33_ptconvlstm__dense_layer__linear_bwd_weight_tensor1 = section_plasma.create_node<BackingPmu>("s1.backing_pmu_group_33_ptconvlstm__dense_layer__linear_bwd_weight_tensor1", partition_parent, &section_plasma, backing_pmu_group_33_ptconvlstm__dense_layer__linear_bwd_weight_tensor1_params);
            backing_pmu_group_33_ptconvlstm__dense_layer__linear_bwd_weight_tensor1->configure_node();
            backing_pmu_group_33_ptconvlstm__dense_layer__linear_bwd_weight_tensor1->configure_dram_store(stores, /*multi_reverse*/false, /*multi_reverse_group_size*/0);
            stores.back().timing_group = std::make_pair(TimingGroup::kFinalGroup, 1);
            
            /// Store Group #34;
            BackingPmu::Params backing_pmu_group_34_ptconvlstm__conv_layer__conv2d_bwd_tensor_params;
            backing_pmu_group_34_ptconvlstm__conv_layer__conv2d_bwd_tensor_params.host_fifo_use = false;
            backing_pmu_group_34_ptconvlstm__conv_layer__conv2d_bwd_tensor_params.dram_layout_all = dram_layout_ptconvlstm__conv_layer__conv2d_bwd_tensor;
            ...
            backing_pmu_group_34_ptconvlstm__conv_layer__conv2d_bwd_tensor_params.buffer_node = buffer_node_ptconvlstm__conv_layer__conv2d_bwd_tensor;
            auto *backing_pmu_group_34_ptconvlstm__conv_layer__conv2d_bwd_tensor = section_plasma.create_node<BackingPmu>("s1.backing_pmu_group_34_ptconvlstm__conv_layer__conv2d_bwd_tensor", partition_parent, &section_plasma, backing_pmu_group_34_ptconvlstm__conv_layer__conv2d_bwd_tensor_params);
            backing_pmu_group_34_ptconvlstm__conv_layer__conv2d_bwd_tensor->configure_node();
            backing_pmu_group_34_ptconvlstm__conv_layer__conv2d_bwd_tensor->configure_dram_store(stores, /*multi_reverse*/false, /*multi_reverse_group_size*/0);
            stores.back().timing_group = std::make_pair(TimingGroup::kFinalGroup, 1);
            
            /// Store Group #35;
            BackingPmu::Params backing_pmu_group_35_ptconvlstm__conv_layer__reshape_1_bwd_tensor_params;
            backing_pmu_group_35_ptconvlstm__conv_layer__reshape_1_bwd_tensor_params.host_fifo_use = false;
            backing_pmu_group_35_ptconvlstm__conv_layer__reshape_1_bwd_tensor_params.dram_layout_all = dram_layout_ptconvlstm__conv_layer__reshape_1_bwd_tensor;
            auto buffer_node_ptconvlstm__conv_layer__reshape_1_bwd_tensor = static_cast<BufferNode *>(node.get_node(arc::LogregTorchSamba::NodeEnum::kgbuf1a_1_0_409));
            backing_pmu_group_35_ptconvlstm__conv_layer__reshape_1_bwd_tensor_params.buffer_node = buffer_node_ptconvlstm__conv_layer__reshape_1_bwd_tensor;
            auto *backing_pmu_group_35_ptconvlstm__conv_layer__reshape_1_bwd_tensor = section_plasma.create_node<BackingPmu>("s1.backing_pmu_group_35_ptconvlstm__conv_layer__reshape_1_bwd_tensor", partition_parent, &section_plasma, backing_pmu_group_35_ptconvlstm__conv_layer__reshape_1_bwd_tensor_params);
            backing_pmu_group_35_ptconvlstm__conv_layer__reshape_1_bwd_tensor->configure_node();
            backing_pmu_group_35_ptconvlstm__conv_layer__reshape_1_bwd_tensor->configure_dram_store(stores, /*multi_reverse*/false, /*multi_reverse_group_size*/0);
            stores.back().timing_group = std::make_pair(TimingGroup::kFinalGroup, 1);
    ...
    auto section2_fn = [&](Plasma &section_plasma, SectionId section_id) {    
        ...
        { // Begin Section 2, Chip 0
            ...
            fronting_pmu_load_group_3_params.dram_layout_all = dram_layout_group_3;
            std::vector<BufferNode *> gbufs_load_group_3 {
                node.wbuf_in(arc::LogregTorchSamba::Input::kptconvlstm__dense_layer__weight_2_0_167)                
            };
            fronting_pmu_load_group_3_params.static_buffers = gbufs_load_group_3;
            fronting_pmu_load_group_3_params.atom_transpose = false;
            ...
            std::vector<BufferNode *> gbufs_load_group_14 {
                node.wbuf_in(arc::LogregTorchSamba::Input::kptconvlstm__dense_layer__weight__grad_2_0_168)                
            };
            ...
            std::vector<BufferNode *> gbufs_load_group_12 {
                node.wbuf_in(arc::LogregTorchSamba::Input::kptconvlstm__dense_layer__weight__sgd0__momentum_2_0_169)                
            };
            ...
            fronting_pmu_load_group_11_params.dram_layout_all = dram_layout_group_11;
            std::vector<BufferNode *> gbufs_load_group_11 {
                node.wbuf_in(arc::LogregTorchSamba::Input::kptconvlstm__dense_layer__bias_2_0_173)                
            };
            fronting_pmu_load_group_11_params.static_buffers = gbufs_load_group_11;
            fronting_pmu_load_group_11_params.atom_transpose = false;
            ...
            std::vector<BufferNode *> gbufs_load_group_15 {
                node.wbuf_in(arc::LogregTorchSamba::Input::kptconvlstm__dense_layer__bias__grad_2_0_174)                ,
                node.wbuf_in(arc::LogregTorchSamba::Input::kptconvlstm__conv_layer__bias__grad_2_0_180)                ,
                node.wbuf_in(arc::LogregTorchSamba::Input::kptconvlstm__conv_layer__weight__grad_2_0_186)                
            };
            ...
            std::vector<BufferNode *> gbufs_load_group_13 {
                node.wbuf_in(arc::LogregTorchSamba::Input::kptconvlstm__dense_layer__bias__sgd0__momentum_2_0_175)                ,
                node.wbuf_in(arc::LogregTorchSamba::Input::kptconvlstm__conv_layer__bias__sgd0__momentum_2_0_181)                ,
                node.wbuf_in(arc::LogregTorchSamba::Input::kptconvlstm__conv_layer__weight__sgd0__momentum_2_0_187)                
            };
            ...
            std::vector<BufferNode *> gbufs_load_group_2 {
                node.wbuf_in(arc::LogregTorchSamba::Input::kptconvlstm__conv_layer__bias_2_0_179)                
            };
            ...
            std::vector<BufferNode *> gbufs_load_group_10 {
                node.wbuf_in(arc::LogregTorchSamba::Input::kptconvlstm__conv_layer__weight_2_0_185)                
            };
            ...
            std::vector<DramOutput> stores;
            /// Store Group #3;
            BackingPmu::Params backing_pmu_group_3_ptconvlstm__dense_layer__weight__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor_params;
            backing_pmu_group_3_ptconvlstm__dense_layer__weight__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor_params.host_fifo_use = false;
            backing_pmu_group_3_ptconvlstm__dense_layer__weight__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor_params.dram_layout_all = dram_layout_group_3;
            ...
            backing_pmu_group_3_ptconvlstm__dense_layer__weight__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor_params.weights_buffers = wbufs_group_3;
            backing_pmu_group_3_ptconvlstm__dense_layer__weight__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor_params.generate_allrddone = true;
            auto *backing_pmu_group_3_ptconvlstm__dense_layer__weight__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor = section_plasma.create_node<BackingPmu>("s2.backing_pmu_group_3_ptconvlstm__dense_layer__weight__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor", partition_parent, &section_plasma, backing_pmu_group_3_ptconvlstm__dense_layer__weight__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor_params);
            backing_pmu_group_3_ptconvlstm__dense_layer__weight__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor->configure_node();
            backing_pmu_group_3_ptconvlstm__dense_layer__weight__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor->configure_dram_store(stores, /*multi_reverse*/false, /*multi_reverse_group_size*/0);
            stores.back().timing_group = std::make_pair(TimingGroup::kExecGroup, 1);
            
            /// Store Group #12;
            BackingPmu::Params backing_pmu_group_12_ptconvlstm__dense_layer__weight__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor1_params;
            backing_pmu_group_12_ptconvlstm__dense_layer__weight__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor1_params.host_fifo_use = false;
            backing_pmu_group_12_ptconvlstm__dense_layer__weight__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor1_params.dram_layout_all = dram_layout_group_12;
            ...
            backing_pmu_group_12_ptconvlstm__dense_layer__weight__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor1_params.weights_buffers = wbufs_group_12;
            backing_pmu_group_12_ptconvlstm__dense_layer__weight__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor1_params.generate_allrddone = true;
            auto *backing_pmu_group_12_ptconvlstm__dense_layer__weight__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor1 = section_plasma.create_node<BackingPmu>("s2.backing_pmu_group_12_ptconvlstm__dense_layer__weight__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor1", partition_parent, &section_plasma, backing_pmu_group_12_ptconvlstm__dense_layer__weight__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor1_params);
            backing_pmu_group_12_ptconvlstm__dense_layer__weight__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor1->configure_node();
            backing_pmu_group_12_ptconvlstm__dense_layer__weight__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor1->configure_dram_store(stores, /*multi_reverse*/false, /*multi_reverse_group_size*/0);
            stores.back().timing_group = std::make_pair(TimingGroup::kExecGroup, 1);
            
            /// Store Group #11;
            BackingPmu::Params backing_pmu_group_11_ptconvlstm__dense_layer__bias__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor_params;
            backing_pmu_group_11_ptconvlstm__dense_layer__bias__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor_params.host_fifo_use = false;
            backing_pmu_group_11_ptconvlstm__dense_layer__bias__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor_params.dram_layout_all = dram_layout_group_11;
            ...
            backing_pmu_group_11_ptconvlstm__dense_layer__bias__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor_params.weights_buffers = wbufs_group_11;
            backing_pmu_group_11_ptconvlstm__dense_layer__bias__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor_params.generate_allrddone = true;
            auto *backing_pmu_group_11_ptconvlstm__dense_layer__bias__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor = section_plasma.create_node<BackingPmu>("s2.backing_pmu_group_11_ptconvlstm__dense_layer__bias__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor", partition_parent, &section_plasma, backing_pmu_group_11_ptconvlstm__dense_layer__bias__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor_params);
            backing_pmu_group_11_ptconvlstm__dense_layer__bias__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor->configure_node();
            backing_pmu_group_11_ptconvlstm__dense_layer__bias__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor->configure_dram_store(stores, /*multi_reverse*/false, /*multi_reverse_group_size*/0);
            stores.back().timing_group = std::make_pair(TimingGroup::kExecGroup, 1);
            
            /// Store Group #13;
            BackingPmu::Params backing_pmu_group_13_ptconvlstm__dense_layer__bias__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor1_params;
            backing_pmu_group_13_ptconvlstm__dense_layer__bias__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor1_params.host_fifo_use = false;
            backing_pmu_group_13_ptconvlstm__dense_layer__bias__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor1_params.dram_layout_all = dram_layout_group_13;
            std::vector<WeightsBuffer *> wbufs_group_13 {
                ...
                node.wbuf_out(arc::LogregTorchSamba::Output::kptconvlstm__conv_layer__bias__ptconvlstm__conv_layer__conv2d_bwd_opt_tensor1)                ,
                node.wbuf_out(arc::LogregTorchSamba::Output::kptconvlstm__conv_layer__weight__ptconvlstm__conv_layer__reshape_1_bwd_opt_tensor1)                
            };
            backing_pmu_group_13_ptconvlstm__dense_layer__bias__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor1_params.weights_buffers = wbufs_group_13;
            backing_pmu_group_13_ptconvlstm__dense_layer__bias__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor1_params.generate_allrddone = true;
            auto *backing_pmu_group_13_ptconvlstm__dense_layer__bias__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor1 = section_plasma.create_node<BackingPmu>("s2.backing_pmu_group_13_ptconvlstm__dense_layer__bias__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor1", partition_parent, &section_plasma, backing_pmu_group_13_ptconvlstm__dense_layer__bias__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor1_params);
            backing_pmu_group_13_ptconvlstm__dense_layer__bias__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor1->configure_node();
            backing_pmu_group_13_ptconvlstm__dense_layer__bias__ptconvlstm__dense_layer__linear_bwd_weight_opt_tensor1->configure_dram_store(stores, /*multi_reverse*/false, /*multi_reverse_group_size*/0);
            stores.back().timing_group = std::make_pair(TimingGroup::kExecGroup, 1);
            
            /// Store Group #2;
            BackingPmu::Params backing_pmu_group_2_ptconvlstm__conv_layer__bias__ptconvlstm__conv_layer__conv2d_bwd_opt_tensor_params;
            backing_pmu_group_2_ptconvlstm__conv_layer__bias__ptconvlstm__conv_layer__conv2d_bwd_opt_tensor_params.host_fifo_use = false;
            backing_pmu_group_2_ptconvlstm__conv_layer__bias__ptconvlstm__conv_layer__conv2d_bwd_opt_tensor_params.dram_layout_all = dram_layout_group_2;
            std::vector<WeightsBuffer *> wbufs_group_2 {
                node.wbuf_out(arc::LogregTorchSamba::Output::kptconvlstm__conv_layer__bias__ptconvlstm__conv_layer__conv2d_bwd_opt_tensor)                
            };
            backing_pmu_group_2_ptconvlstm__conv_layer__bias__ptconvlstm__conv_layer__conv2d_bwd_opt_tensor_params.weights_buffers = wbufs_group_2;
            backing_pmu_group_2_ptconvlstm__conv_layer__bias__ptconvlstm__conv_layer__conv2d_bwd_opt_tensor_params.generate_allrddone = true;
            auto *backing_pmu_group_2_ptconvlstm__conv_layer__bias__ptconvlstm__conv_layer__conv2d_bwd_opt_tensor = section_plasma.create_node<BackingPmu>("s2.backing_pmu_group_2_ptconvlstm__conv_layer__bias__ptconvlstm__conv_layer__conv2d_bwd_opt_tensor", partition_parent, &section_plasma, backing_pmu_group_2_ptconvlstm__conv_layer__bias__ptconvlstm__conv_layer__conv2d_bwd_opt_tensor_params);
            backing_pmu_group_2_ptconvlstm__conv_layer__bias__ptconvlstm__conv_layer__conv2d_bwd_opt_tensor->configure_node();
            backing_pmu_group_2_ptconvlstm__conv_layer__bias__ptconvlstm__conv_layer__conv2d_bwd_opt_tensor->configure_dram_store(stores, /*multi_reverse*/false, /*multi_reverse_group_size*/0);
            stores.back().timing_group = std::make_pair(TimingGroup::kExecGroup, 1);
            
            /// Store Group #10;
            BackingPmu::Params backing_pmu_group_10_ptconvlstm__conv_layer__weight__ptconvlstm__conv_layer__reshape_1_bwd_opt_tensor_params;
            backing_pmu_group_10_ptconvlstm__conv_layer__weight__ptconvlstm__conv_layer__reshape_1_bwd_opt_tensor_params.host_fifo_use = false;
            backing_pmu_group_10_ptconvlstm__conv_layer__weight__ptconvlstm__conv_layer__reshape_1_bwd_opt_tensor_params.dram_layout_all = dram_layout_group_10;
            std::vector<WeightsBuffer *> wbufs_group_10 {
                node.wbuf_out(arc::LogregTorchSamba::Output::kptconvlstm__conv_layer__weight__ptconvlstm__conv_layer__reshape_1_bwd_opt_tensor)                
            };
            backing_pmu_group_10_ptconvlstm__conv_layer__weight__ptconvlstm__conv_layer__reshape_1_bwd_opt_tensor_params.weights_buffers = wbufs_group_10;
            backing_pmu_group_10_ptconvlstm__conv_layer__weight__ptconvlstm__conv_layer__reshape_1_bwd_opt_tensor_params.generate_allrddone = true;
            auto *backing_pmu_group_10_ptconvlstm__conv_layer__weight__ptconvlstm__conv_layer__reshape_1_bwd_opt_tensor = section_plasma.create_node<BackingPmu>("s2.backing_pmu_group_10_ptconvlstm__conv_layer__weight__ptconvlstm__conv_layer__reshape_1_bwd_opt_tensor", partition_parent, &section_plasma, backing_pmu_group_10_ptconvlstm__conv_layer__weight__ptconvlstm__conv_layer__reshape_1_bwd_opt_tensor_params);
            backing_pmu_group_10_ptconvlstm__conv_layer__weight__ptconvlstm__conv_layer__reshape_1_bwd_opt_tensor->configure_node();
            backing_pmu_group_10_ptconvlstm__conv_layer__weight__ptconvlstm__conv_layer__reshape_1_bwd_opt_tensor->configure_dram_store(stores, /*multi_reverse*/false, /*multi_reverse_group_size*/0);
            stores.back().timing_group = std::make_pair(TimingGroup::kExecGroup, 1);
