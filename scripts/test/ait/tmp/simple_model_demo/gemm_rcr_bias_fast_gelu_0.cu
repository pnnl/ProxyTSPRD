...
using feefbd78dfe45171b4c2f1327dec83f62b3510779 = Operation_cutlass_tensorop_f16_s16816gemm_f16_64x128_64x3_tn_align8;
...
void gemm_rcr_bias_fast_gelu_0 (
 ...
 int64_t K = (*a_dim1);
  ...
  if (M == 1024 && N == 2048 && K == 512) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename feefbd78dfe45171b4c2f1327dec83f62b3510779::ElementAccumulator;

    typename feefbd78dfe45171b4c2f1327dec83f62b3510779::Arguments arguments{
    ...
    feefbd78dfe45171b4c2f1327dec83f62b3510779 gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this gemm_rcr_bias_fast_gelu_0 specialization."
  );
}