...
ctxs.append('LogregTorchSamba_partition_1_0__ptconvlstm__lambda_layer__indexselect_recompute__kIndexRd_0_0__dup0_R')
def LogregTorchSamba_partition_1_0__ptconvlstm__lambda_layer__indexselect_recompute__kIndexRd_0_0__dup0_R():
    ndaddrs = []
    x0 = 32
    x1 = 136
    x2 = True
...
ndaddr_funcs['LogregTorchSamba_partition_1_0__ptconvlstm__lambda_layer__indexselect_recompute__kIndexRd_0_0__dup0_R'] = LogregTorchSamba_partition_1_0__ptconvlstm__lambda_layer__indexselect_recompute__kIndexRd_0_0__dup0_R
