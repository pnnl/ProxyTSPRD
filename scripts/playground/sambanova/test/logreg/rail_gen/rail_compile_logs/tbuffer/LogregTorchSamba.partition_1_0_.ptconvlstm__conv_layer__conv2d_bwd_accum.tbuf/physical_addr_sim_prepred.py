...
def D_0_0_0_w_loop_0_0_0_0_0__dup0_W():
    ...
    for x4 in range(x0,x2,x1):
        x5 = True
        print("wt byte:{} word:{} vec:{} rotate:{} en_zero:{} en_pred:{} min_max:{}".format(qaddr(x4),qaddr(x4//2),qaddr(x4//64),qaddr(x0),x3,x3,True,))
    return ndaddrs
...
def D_0_0_0_kBackReadCtx_0_0__dup0_R():
    ...
    for x4 in range(x0,x2,x1):
        x5 = True
        print("rd byte:{} word:{} vec:{} rotate:{} en_zero:{} en_pred:{} min_max:{}".format(qaddr(x4),qaddr(x4//2),qaddr(x4//64),qaddr(x0),x3,x3,True,))
    return ndaddrs
