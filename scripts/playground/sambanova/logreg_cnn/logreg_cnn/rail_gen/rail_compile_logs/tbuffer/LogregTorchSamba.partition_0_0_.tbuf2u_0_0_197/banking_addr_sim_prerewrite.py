...
ctxs.append('LogregTorchSamba_partition_0_0__ptconvcnn__lambda_layer__indexselect_kLutRd')
def LogregTorchSamba_partition_0_0__ptconvcnn__lambda_layer__indexselect_kLutRd():
    x0 = 64
    x1 = 19200
    x2 = 1
    x3 = 3
...
ndaddr_funcs['LogregTorchSamba_partition_0_0__ptconvcnn__lambda_layer__indexselect_kLutRd'] = LogregTorchSamba_partition_0_0__ptconvcnn__lambda_layer__indexselect_kLutRd
