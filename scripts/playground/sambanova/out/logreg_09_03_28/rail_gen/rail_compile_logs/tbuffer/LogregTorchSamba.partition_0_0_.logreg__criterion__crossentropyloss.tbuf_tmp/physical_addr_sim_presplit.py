...
ctxs.append('D_0_0.phase_w0_0_dup0_W')
if opts.ctx == 'D_0_0.phase_w0_0_dup0_W':
    x0 = 32
    x1 = 1
    x2 = 768
    x3 = 0
    ...
    for x5 in range(x3,x1,x0):
        ...
        pass
ctxs.append('D_0_0.phase1_R_max_0_0_dup0_R')
if opts.ctx == 'D_0_0.phase1_R_max_0_0_dup0_R':
    x0 = 1
    x1 = 12
    x2 = 768
    x3 = 0
...
if opts.ctx == 'D_0_0.phase_rd_dummy_0_dup0_R':
    ...
    for x2 in range(x0,x1,x1):
        ...
        pass
ctxs.append('D_0_0.phase_w1_0_0_dup0_W')
if opts.ctx == 'D_0_0.phase_w1_0_0_dup0_W':
    x0 = 768
    x1 = 1
    x2 = 32
    x3 = 0
    ...
    for x7 in range(x3,x1,x2):
        for x6 in range(x3,x0,x4):
            ...
            pass
ctxs.append('D_0_0.phase2_R_exp_0_0_dup0_R')
if opts.ctx == 'D_0_0.phase2_R_exp_0_0_dup0_R':
    x0 = 640
    x1 = 1
    x2 = 32
    x3 = 64
    ...
    for x5 in range(x4,x1,x2):
        for x6 in range(x4,x0,x3):
            ...
            pass
ctxs.append('D_0_0.phase_w2_0_dup0_W')
if opts.ctx == 'D_0_0.phase_w2_0_dup0_W':
    x0 = 32
    x1 = 1
    x2 = 832
    x3 = 0
    ...
    for x5 in range(x3,x1,x0):
        ...
        print("wt byte:{} word:{} vec:{} rotate:{} pred:{} min_max:{}".format(qaddr(x2),qaddr(x2//2),qaddr(x2//64),qaddr(x3),x4,True,))
        pass
ctxs.append('D_0_0.phase3_R_max_0_dup0_R')
if opts.ctx == 'D_0_0.phase3_R_max_0_dup0_R':
    x0 = 1
    x1 = 768
    x2 = 0
    for x3 in range(x2,x0,x0):
        x4 = True
        print("rd byte:{} word:{} vec:{} rotate:{} pred:{} min_max:{}".format(qaddr(x1),qaddr(x1//2),qaddr(x1//64),qaddr(x2),x2,True,))
        pass
ctxs.append('D_0_0.phase3_R_logsum_0_dup0_R')
if opts.ctx == 'D_0_0.phase3_R_logsum_0_dup0_R':
    x0 = 1
    x1 = 832
    x2 = 0
    for x3 in range(x2,x0,x0):
