...
if opts.ctx == 'kFrontDynamicWriteCtx_0_dup0_W':
    ...
    for x4 in range(x3,x1,x0):
        ...
        pass
ctxs.append('LogregTorchSamba.partition_1_0_.logreg__criterion__crossentropyloss_bwd_loss@kInputY_0_0_0_dup0_R')
if opts.ctx == 'LogregTorchSamba.partition_1_0_.logreg__criterion__crossentropyloss_bwd_loss@kInputY_0_0_0_dup0_R':
    x0 = 12
    x1 = 32
    x2 = 1
    x3 = True
