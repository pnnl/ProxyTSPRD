...
ctxs.append('phase_y_copy_write_0_dup0_W')
if opts.ctx == 'phase_y_copy_write_0_dup0_W':
    x0 = 32
    x1 = 1
    x2 = True
    x3 = 0
    for x4 in range(x3,x1,x0):
        ...
        pass
ctxs.append('phase_y_copy_read_0_dup0_R')
if opts.ctx == 'phase_y_copy_read_0_dup0_R':
    x0 = 1
    x1 = True
    x2 = 0
