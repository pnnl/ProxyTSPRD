...
using fdd9795d8419a9aff110745023ab19fc34da3a510 = cutlass::conv::device::ImplicitGemmConvolution<cutlass_tensorop_f16_s16816fprop_fixed_channels_f16_128x64_64x3_nhwc_align4_base>;



void conv2d_bias_hardswish_few_channels_0 (
    void* in_ptr,
    void* weight_ptr,
    void* out_ptr,
    void* bias_ptr,
  ...
  *out_ch = CO;
  ...
  if (NI == 1024 && HI == 60 && WI == 136 && CI == 4) {
    
    using ElementComputeEpilogue = typename fdd9795d8419a9aff110745023ab19fc34da3a510::ElementCompute;
//  TODO: cast to right dtype
    typename fdd9795d8419a9aff110745023ab19fc34da3a510::Arguments arguments{
        problem_size,
    ...
    fdd9795d8419a9aff110745023ab19fc34da3a510 implicit_gemm_op;
