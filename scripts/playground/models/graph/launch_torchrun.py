...
def construct_torch_dist_launcher_cmd(
    ...
    # torch_cmd_template = "-m torchrun " \
    torch_cmd_template = "torchrun " \
...
def wrap_udf_in_torch_dist_launcher(
    ...
    new_udf_command = udf_command.replace(python_bin, f"{torch_dist_cmd}")
    # print("============== New Command", new_udf_command)
