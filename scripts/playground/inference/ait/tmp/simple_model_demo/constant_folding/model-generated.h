...
class Model {
  ...
  InitConstants(constants_);
    ...
    void SetUpInputsOutputs() {
             concatenate_5_0 = static_cast<decltype(concatenate_5_0)>(params_[0].ptr);

if (concatenate_5_0 == nullptr) {
    throw std::runtime_error("Constant concatenate_5_0 was not set! Set the value with set_constant.");
}
  ...
  
  {
    ...
    const void *inputs[] = {
      ...
      int64_t dense_layer_weight_shape_0[] = {
        dense_layer_weight_dim_0, dense_layer_weight_dim_1
      };
      int64_t tensor_1_shape_1[] = {
        dense_layer_weight_dim_0, tensor_1_dim_1
      };

    const int64_t *real_input_shapes[] = {
      dense_layer_weight_shape_0, tensor_1_shape_1
    };
    ...
    int64_t *concatenate_5_0_shape[] = {
      &dense_layer_weight_dim_0, &concatenate_5_0_dim_1
    };

    int64_t concat_dim_sizes[] = {
      dense_layer_weight_dim_1, tensor_1_dim_1
    };
  ...
  private:
    ...
    dense_layer_weight = reinterpret_cast<decltype(dense_layer_weight)>(constants + 28864);
    dense_layer_bias = reinterpret_cast<decltype(dense_layer_bias)>(constants + 657216);
    tensor_0 = reinterpret_cast<decltype(tensor_0)>(constants + 665408);
    tensor_1 = reinterpret_cast<decltype(tensor_1)>(constants + 671552);
           params_[0].shape_ptrs = {ParamDim(4080, 4080, &dense_layer_weight_dim_0), ParamDim(80, 80, &concatenate_5_0_dim_1)};
    }
   ...
   void* dense_layer_weight {nullptr};
   void* dense_layer_bias {nullptr};
   void* tensor_0 {nullptr};
   void* tensor_1 {nullptr};
