...
def main():
    ...
    def LogregTorchSamba.partition_1_0_.ptconvcnn__lambda_layer__indexselect_recompute_@kOutWr():
        matrix = crvrm.convert_to_rvrm(addrs, opts.data_file, '', 32, 0, [160, 3, ])
        np.save('RVRM_LogregTorchSamba.partition_1_0_.ptconvcnn__lambda_layer__indexselect_recompute_@kOutWr.npy', matrix)
    if opts.ctx == 'LogregTorchSamba.partition_1_0_.ptconvcnn__lambda_layer__indexselect_recompute_@kOutWr':
        LogregTorchSamba.partition_1_0_.ptconvcnn__lambda_layer__indexselect_recompute_@kOutWr()
