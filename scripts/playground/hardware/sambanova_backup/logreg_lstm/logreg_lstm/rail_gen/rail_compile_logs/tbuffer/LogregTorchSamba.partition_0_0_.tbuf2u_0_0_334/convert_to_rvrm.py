...
def main():
    ...
    def LogregTorchSamba.partition_0_0_.ptconvlstm__indexselect@kLutRd():
        matrix = crvrm.convert_to_rvrm(addrs, opts.data_file, '', 32, 1, [60, 64, ])
        np.save('RVRM_LogregTorchSamba.partition_0_0_.ptconvlstm__indexselect@kLutRd.npy', matrix)
    if opts.ctx == 'LogregTorchSamba.partition_0_0_.ptconvlstm__indexselect@kLutRd':
        LogregTorchSamba.partition_0_0_.ptconvlstm__indexselect@kLutRd()
