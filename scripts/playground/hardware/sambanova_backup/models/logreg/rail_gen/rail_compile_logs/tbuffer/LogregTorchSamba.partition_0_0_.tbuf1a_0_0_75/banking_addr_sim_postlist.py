...
ctxs.append('LogregTorchSamba.partition_0_0_.logreg__criterion__crossentropyloss@kOutput_0_0_dup0_W')
if opts.ctx == 'LogregTorchSamba.partition_0_0_.logreg__criterion__crossentropyloss@kOutput_0_0_dup0_W':
    x0 = 1
    x1 = True
    x2 = 0
    for x4 in range(x2,x0,x0):
        ...
        print("wt byte:{} word:{} vec:{} rotate:{} en_zero:{} en_pred:{} min_max:{}".format(qaddr(x2),qaddr(x2//2),qaddr(x2//64),qaddr(x2),x1,x1,True,))
        pass
