...
def main():
    ...
    def LogregTorchSamba.partition_0_0_.ptconvlstm__indexselect@kIndexRd():
        matrix = crvrm.convert_to_rvrm(addrs, opts.data_file, '', 16, -1, [1, ])
        np.save('RVRM_LogregTorchSamba.partition_0_0_.ptconvlstm__indexselect@kIndexRd.npy', matrix)
    if opts.ctx == 'LogregTorchSamba.partition_0_0_.ptconvlstm__indexselect@kIndexRd':
        LogregTorchSamba.partition_0_0_.ptconvlstm__indexselect@kIndexRd()
