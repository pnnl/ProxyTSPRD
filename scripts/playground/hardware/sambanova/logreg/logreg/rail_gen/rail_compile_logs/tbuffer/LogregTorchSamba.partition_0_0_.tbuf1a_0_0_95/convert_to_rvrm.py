...
def main():
    ...
    def LogregTorchSamba.partition_0_0_.logreg__criterion__crossentropyloss@kInputY():
        matrix = crvrm.convert_to_rvrm(addrs, opts.data_file, '', 32, -1, [512, ])
        np.save('RVRM_LogregTorchSamba.partition_0_0_.logreg__criterion__crossentropyloss@kInputY.npy', matrix)
    if opts.ctx == 'LogregTorchSamba.partition_0_0_.logreg__criterion__crossentropyloss@kInputY':
        LogregTorchSamba.partition_0_0_.logreg__criterion__crossentropyloss@kInputY()
