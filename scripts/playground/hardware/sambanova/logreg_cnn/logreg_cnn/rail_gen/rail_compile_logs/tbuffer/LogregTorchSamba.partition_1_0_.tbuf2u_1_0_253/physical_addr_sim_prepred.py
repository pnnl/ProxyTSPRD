...
ctxs.append('D_0_0_LogregTorchSamba_partition_1_0__ptconvcnn__lambda_layer__indexselect_recompute__kLutRd')
def D_0_0_LogregTorchSamba_partition_1_0__ptconvcnn__lambda_layer__indexselect_recompute__kLutRd():
    x0 = 19200
    x1 = 1
    x2 = 3
    x3 = 64
...
ndaddr_funcs['D_0_0_LogregTorchSamba_partition_1_0__ptconvcnn__lambda_layer__indexselect_recompute__kLutRd'] = D_0_0_LogregTorchSamba_partition_1_0__ptconvcnn__lambda_layer__indexselect_recompute__kLutRd
