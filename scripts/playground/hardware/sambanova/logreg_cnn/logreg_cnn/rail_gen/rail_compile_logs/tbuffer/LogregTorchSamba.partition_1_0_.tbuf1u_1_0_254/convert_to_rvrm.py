...
def main():
    ...
    def LogregTorchSamba.partition_1_0_.ptconvcnn__lambda_layer__indexselect_recompute_@kIndexRd():
        matrix = crvrm.convert_to_rvrm(addrs, opts.data_file, '', 16, -1, [3, ])
        np.save('RVRM_LogregTorchSamba.partition_1_0_.ptconvcnn__lambda_layer__indexselect_recompute_@kIndexRd.npy', matrix)
    if opts.ctx == 'LogregTorchSamba.partition_1_0_.ptconvcnn__lambda_layer__indexselect_recompute_@kIndexRd':
        LogregTorchSamba.partition_1_0_.ptconvcnn__lambda_layer__indexselect_recompute_@kIndexRd()
