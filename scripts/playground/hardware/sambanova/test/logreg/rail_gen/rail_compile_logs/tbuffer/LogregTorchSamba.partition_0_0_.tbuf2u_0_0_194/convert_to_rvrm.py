...
def main():
    ...
    def LogregTorchSamba.partition_0_0_.ptconvlstm__lambda_layer__indexselect@kOutWr():
        matrix = crvrm.convert_to_rvrm(addrs, opts.data_file, 'kPredicateForceZero', 32, 0, [160, 3, ])
        np.save('RVRM_LogregTorchSamba.partition_0_0_.ptconvlstm__lambda_layer__indexselect@kOutWr.npy', matrix)
    if opts.ctx == 'LogregTorchSamba.partition_0_0_.ptconvlstm__lambda_layer__indexselect@kOutWr':
        LogregTorchSamba.partition_0_0_.ptconvlstm__lambda_layer__indexselect@kOutWr()
