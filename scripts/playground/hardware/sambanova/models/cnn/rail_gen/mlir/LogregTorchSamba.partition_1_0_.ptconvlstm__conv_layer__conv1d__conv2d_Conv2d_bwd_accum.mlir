module @LogregTorchSamba.partition_1_0_.ptconvlstm__conv_layer__conv1d__conv2d_Conv2d_bwd_accum  {
  module @tbuf  {
    "rail.buffer"() ( {
      "rail.tbuffer_context"() ( {
        ...
        %6 = "rail.const"() {kSourceContext = "software/compiler/apps/rail/par_accum/template/src/ParAccum.cpp:342:0", kValue = 480 : i64} : () -> i64
        ...
        %12 = "rail.const"() {kSourceContext = "software/compiler/apps/rail/par_accum/template/src/ParAccum.cpp:342:0", kValue = 256 : i64} : () -> i64
        ...
        %16 = "rail.const"() {kSourceContext = "software/compiler/apps/rail/par_accum/template/src/ParAccum.cpp:342:0", kValue = 480 : i64} : () -> i64
      ...
      "rail.tbuffer_context"() ( {
        ...
        %2 = "rail.const"() {kSourceContext = "software/compiler/apps/rail/par_accum/template/src/ParAccum.cpp:487:0", kValue = 480 : i64} : () -> i64
        ...
        %8 = "rail.const"() {kSourceContext = "software/compiler/apps/rail/par_accum/template/src/ParAccum.cpp:487:0", kValue = 256 : i64} : () -> i64
