module @logreg_sections_0_2 attributes {plasma.kVerbose = false}  {
  plasma.Section @s0 attributes {kControlBlockId = 0 : i64}  {
    ...
    ^bb0(%arg0: !plasma.TLMemRef<!plasma.TL<25088xbf16:RVRM>,0,R>, %arg1: !plasma.TLMemRef<!plasma.TL<784x1xbf16:CVRM:64>,0,R>, %arg2: !plasma.TLMemRef<!plasma.TL<1xsi16:RVRM:64>,0,R>, %arg3: !plasma.TLMemRef<!plasma.TL<1x10xbf16:RVRM:64>,0,W>, %arg4: !plasma.TLMemRef<!plasma.TL<1xbf16:RVRM:64>,0,W>):  // no predecessors
      ...
      ^bb0(%arg5: !plasma.VectorSrc, %arg6: !plasma.ControlSink, %arg7: !plasma.VectorSink, %arg8: !plasma.ScalarSrc, %arg9: !plasma.ControlSink, %arg10: !plasma.ScalarSrc, %arg11: !plasma.ControlSink, %arg12: !plasma.VectorSink, %arg13: !plasma.ControlSink, %arg14: !plasma.VectorSrc, %arg15: !plasma.ControlSink, %arg16: !plasma.VectorSink):  // no predecessors
      } : () -> (!plasma.Unitref, !plasma.VectorSrc, !plasma.ControlSink, !plasma.VectorSink, !plasma.ScalarSrc, !plasma.ControlSink, !plasma.ScalarSrc, !plasma.ControlSink, !plasma.VectorSink, !plasma.ControlSink, !plasma.VectorSrc, !plasma.ControlSink, !plasma.VectorSink)
      ...
      "plasma.Connection"(%u9s#2, %u10s#7) : (!plasma.VectorSrc, !plasma.VectorSink) -> ()
      "plasma.Connection"(%u9s#3, %u10s#10) : (!plasma.ControlSrc, !plasma.ControlSink) -> ()
      "plasma.Connection"(%u9s#7, %u10s#11) : (!plasma.VectorSrc, !plasma.VectorSink) -> ()
      "plasma.Connection"(%u9s#8, %u10s#1) : (!plasma.ControlSrc, !plasma.ControlSink) -> ()
      "plasma.Connection"(%u9s#11, %u10s#2) : (!plasma.VectorSrc, !plasma.VectorSink) -> ()
      "plasma.Connection"(%u9s#12, %u10s#6) : (!plasma.ControlSrc, !plasma.ControlSink) -> ()
      "plasma.Connection"(%u9s#12, %u10s#4) : (!plasma.ControlSrc, !plasma.ControlSink) -> ()
      "plasma.Connection"(%u9s#19, %u10s#8) : (!plasma.ControlSrc, !plasma.ControlSink) -> ()
      ...
      "plasma.Connection"(%u10s#9, %u9s#5) : (!plasma.VectorSrc, !plasma.VectorSink) -> ()
      "plasma.Connection"(%u10s#0, %u9s#9) : (!plasma.VectorSrc, !plasma.VectorSink) -> ()
      "plasma.Connection"(%u10s#5, %u9s#13) : (!plasma.ScalarSrc, !plasma.ScalarSink) -> ()
      "plasma.Connection"(%u10s#3, %u9s#15) : (!plasma.ScalarSrc, !plasma.ScalarSink) -> ()
