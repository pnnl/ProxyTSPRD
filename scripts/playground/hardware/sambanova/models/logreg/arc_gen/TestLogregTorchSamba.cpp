...
int main(int argc, char **argv) {
    ...
    /** Plasma Init **/
    std::string output_path = "/qfs/people/jain432/pacer_saudade/code/sample_scripts/models/logreg/arc_gen/../";
    make_dirs(output_path);
    BitfileTypePerChip chip_types (1);
    std::fill(chip_types.begin(), chip_types.end(), BitfileType::kFourTile);
    mlir::shared::util::cl_output_folder.setInitialValue("/qfs/people/jain432/pacer_saudade/code/sample_scripts/models/logreg/arc_gen/../");
    mlir::shared::util::cl_pef_name.setInitialValue("logreg");
